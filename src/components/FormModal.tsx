...
import { deleteArea, deleteLocation } from "@/lib/actions";
...
const AreaForm = dynamic(() => import("./forms/AreaForm"), {
  loading: () => <h1>Loading...</h1>,
});
...
const forms: {
  ...
  //  />
  //),
  area: (setOpen, type, data, relatedData) => (
    <AreaForm
      type={type}
      data={data}
      setOpen={setOpen}
    ...
    return type === "delete" && id ? (
      <form action={formAction} className="p-4 flex flex-col gap-4">
        ...
        <span className="text-center font-medium">
          All data will be lost, are you sure want to delete this item {table}?
        </span>
